...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/user_style/favicon.ico"> <link href="${pageContext.request.contextPath}/user_style/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="${pageContext.request.contextPath}/user_style/projects.html" class="btn btn-primary btn-xs">创建新项目</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="project-title">
                                            <a href="${pageContext.request.contextPath}/user_style/project_detail.html">LIKE－一款能够让用户快速获得认同感的兴趣社交应用</a>
                                            <br/>
                                        ...
                                        <td class="project-people">
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html"><img alt="image" class="img-circle" src="img/a3.jpg"></a>
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html"><img alt="image" class="img-circle" src="img/a1.jpg"></a>
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html"><img alt="image" class="img-circle" src="img/a2.jpg"></a>
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html"><img alt="image" class="img-circle" src="img/a4.jpg"></a>
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html"><img alt="image" class="img-circle" src="img/a5.jpg"></a>
                                        </td>
                                        <td class="project-actions">
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
                                            <a href="${pageContext.request.contextPath}/user_style/projects.html#" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> 编辑 </a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="project-status">

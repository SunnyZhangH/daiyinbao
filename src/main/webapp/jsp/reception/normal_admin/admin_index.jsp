...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/buxuser_style/js/plugins/favicon.ico"> <link href="${pageContext.request.contextPath}/user_style/css/bootstrap.min.css?v=3.3.6" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/user_style/css/font-awesome.min.css?v=4.4.0" rel="stylesheet">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">身份显示-</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        <a class="J_menuItem" href="${pageContext.request.contextPath}/jsp/reception/normal_admin/admin_index_v1.jsp">
         ...
         <%--           <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_echarts.html">百度ECharts</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_flot.html">Flot</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_morris.html">Morris.js</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_rickshaw.html">Rickshaw</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_peity.html">Peity</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/graph_sparkline.html">Sparkline</a>
                            </li>
                            <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/form_webuploader.html">百度WebUploader</a>
                                    </li>
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/form_file_upload.html">DropzoneJS</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/form_editors.html">富文本编辑器</a>
                                    </li>
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/form_simditor.html">simditor</a>
                                    </li>
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/form_markdown.html">MarkDown编辑器</a>
                                    </li>
                                    <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/code_editor.html">代码编辑器</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/layerdate.html">日期选择器layerDate</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/teams_board.html">团队管理</a>
                            </li>
                            <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/social_feed.html">信息流</a>
                            </li>
                            <li><a class="J_menuItem" href="${pageContext.request.contextPath}/user_style/clients.html">客户管理</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="${pageContext.request.contextPath}/jsp/reception/normal_admin/admin_index_v1.jsp" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    ...
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath}/user_style/js/hAdmin.js?v=4.1.0"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/user_style/js/index.js"></script>

    <!-- 第三方插件 -->
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/pace/pace.min.js"></script>
<div style="text-align:center;">
<p>来源:<a href="http://www.cssmoban.com/" target="_blank">模板之家</a></p>
</div>
</body>

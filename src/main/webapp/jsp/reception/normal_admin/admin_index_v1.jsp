...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/flot/jquery.flot.js"></script>
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${pageContext.request.contextPath}/user_style/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="${pageContext.request.contextPath}/user_style/js/content.js"></script>
    <!--flotdemo-->

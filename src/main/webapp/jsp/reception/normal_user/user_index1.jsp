			...
			<div class="inner clearfix">
				...
				<div class="userBar topItem">
					<div class="portrait fl">
						<img src="${pageContext.request.contextPath}/admin_style/images/portrait.jpg">
					</div>
	...
	<div id="main">
		<div class="content">
			<div class="indexBanner">
				<img src="${pageContext.request.contextPath}/admin_style/images/banner1.jpg">
			</div>
			<div class="contBox">
				<div class="contW">
					<!--余额-->
					<ul class="balanList clearfix">
						<li>
							<h2>账户余额（元）</h2>
							<p><span>10.00</span></p>
							<div class="balanBottom"><a class="" href="">充值</a></div>
						</li>
						<li>
							<h2>提现余额（元）</h2>
							<p>0.00</p>
					...
					<!--最新信息-->
					<div class="news">
						<div class="newsTit"><h2>最新信息</h2></div>
						<div class="newsW">
							<ul>
								<li><a href="">
									<span class="btnSj"></span><p>公测阶段，有BUG请及时反馈。</p>
								</a></li>
								<li><a href="">
									<span class="btnSj"></span><p>公测阶段，有BUG请及时反馈。</p>
								</a></li>
					...
					<div class="promo">
						<h2>下线推广链接</h2>
						<div class="promoW"><a href="">XXX</a></div>
						<p>（别人通过你的此链接注册账号，你将得到5%的消费分成哦）</p>
						<h2>开发者参数</h2>
						<div class="promoW">u1255</div>
			...
			<div id="footer">
				<p>Copyright ©2020 All Rights <a href="http://www.17sucai.com/" title="17sucai">Reserved</a>. 苏ICP备XXX号</p>
			</div>
